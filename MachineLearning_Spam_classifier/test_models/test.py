...
def data_test():
    ...
    dataset = pd.read_csv('https://raw.githubusercontent.com/amankharwal/SMS-Spam-Detection/master/spam.csv', sep=',', encoding='latin-1')

    message_test_1 = dataset['message'][:15]
    solutions = dataset['class'][:15]
